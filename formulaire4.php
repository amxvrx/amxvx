...
<div id="pageintro" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <article>
      <h3 class="heading">DEMANDE Du certificat de sortie (quitus)</h3>
	   <p> initier la procedure</p>
      <footer>
...
<form action="formulaire4.php" enctype="multipart/form-data" method="post" onsubmit="return confirm('VOUS CONFIRMEZ VOTRE ACTION?');">
...
<tr>
  ...
  <td colspan=2>
   <img style="height:70px;"src="images/udl.png" >
  <center><font size=5><b> demande du quitus UDL(poure diplomées)</b></font></center>
  <br>
  <br>
  <a style="color: red;">-ATTENTION ! : caette action est IRREVERSIBLE /////////////// - SI VOUS DEMANDEZ CE CERTIFICAT VOUS NE POUREZ PLUS ACCEDER A VOTRE LOGEMENT ( saufe au diplomés de licence apres avoire refomuler leur nouvelles demandes  de logements ). </a>	
  <br>
  </td>
  </tr>
  
  <tr>
  <td><button type="submit" class="btn" name="register_btn4">demander</button><br></td>
  </tr>
