...
<div id="pageintro" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <article>
      <h3 class="heading">DEMANDE DE RENOUVELLEMENT</h3>
	   <p>remplissez votre fomulaire poure initier un renouvellement</p>
      <footer>
...
<form action="formulaire3.php" enctype="multipart/form-data" method="post" onsubmit="return confirm('VOUS CONFIRMEZ VOTRE ACTION?');">
...
<tr>
  ...
  <td colspan=2>
   <img style="height:70px;"src="images/udl.png" >
  <center><font size=5><b>formulaire de renouvellement UDL</b></font></center>
  <br>
   <br>
...
<div class="input-group"> 
 <tr>
  ...
  <td>scanne du nouveau certficat de scholarite<br></td>

  <td><input type="file" name="newscan" id="" > <br></td>
  ...
  <td><button type="submit" class="btn" name="register_btn3">valider formulaire</button><br></td>
