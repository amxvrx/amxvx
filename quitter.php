...
<div id="pageintro" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <article>
      <h3 class="heading">QUITTER VOTRE LOGEMENT </h3>
	   <p>assurez vous de faire le bon choix !</p>
      <footer>
...
<form action="quitter.php" enctype="multipart/form-data" method="post" onsubmit="return confirm('VOUS CONFIRMEZ VOTRE ACTION?');">
...
<table cellpadding="2" width="20%" bgcolor="99FFFF" align="center" cellspacing="2">
  ...
  <br>
   <br> 
  <a style="color: red;">ATTENTION ! : caette action est IRREVERSIBLE , si vous quitez LA RESIDENCE vous ne pouverais plus recuperer VOTRE LOGEMENT , pour avoire un logement vous devrez renvoyez une nouvelle demande de logement. </a>	
  <br>
  <br>
  <tr>
  <td><button type="submit" class="btn" name="quiter_btn"  id="a">QUITTER RESIDENCE</button><br></td>
  </tr>
   </td>
  </table>
  </form>
