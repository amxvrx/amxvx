...
<div id="pageintro" class="hoc clear"> 
    ...
    <article>
      <h3 class="heading">s'inscrire !</h3>
	   <p>remplissez votre fomulaire poure valider l'dmission de votre chambre</p>
      <footer>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    <!-- main body -->
<a href="" style="color: red;">ATTENTION !</a> : chaque adherent doit etre accepte par sa faculte de choix et dois avoire a sa disposition son numero d'etudiant , apuiez ici poure plus d'informations .
	<br>
	<br>
...
<form action="formulaire.php" enctype="multipart/form-data" method="post" onsubmit="return confirm('VOUS CONFIRMEZ VOTRE ACTION?');">
...
<tr>
  ...
  <td colspan=2>
   <img style="height:70px;"src="images/udl.png" >
  <center><font size=5><b>formulaire d'inscription UDL</b></font></center>
  <br>
   <br>
 ...
 <div class="input-group"> 
  ...
  <td><input type=text name=prenom id="textname" size="30"> <br></td>
 <br>
  </tr>
 </div> 
 ...
 <div class="input-group"> 
  ...
  <td><input type=date name=date id="" size="30"> <br></td>
 <br>
  </tr>
</div> 
...
<tr>
  ...
  <td>lieu de naissance<br></td>

  <td><input type="text" name="naissance" id="" size="30"> <br></td>
  </tr>
</div> 
...
<tr>
  ...
  <td>Nom du pére<br></td>

  <td><input type="text" name="pere" id="fathername" size="30"> <br></td>
  </tr>
</div> 
 ...
 <div class="input-group"> 
  ...
  <td>Nom de la mere<br></td>

  <td><input type="text" name="mere" id="mothername" size="30"> <br></td>
  </tr>
</div> 
...
<div class="input-group"> 
  ...
  <td>Code postale<br></td>

  <td><input type="text" name="postal" id="paddress" size="30"> <br></td>
...
<tr>
  ...
  <td>Adresse personelle<br></td>

  <td><input type="text" name="addr"id="personaladdress" size="30"> <br></td>
...
<tr>
  ...
  <option value="GENIE MACANIQUE">GENIE MACANIQUE</option>

  <option value="ELECTROTECHNIQUE">ELECTROTECHNIQUE</option>

  <option value="TELECOMUUNICATION">TELECOMUUNICATION</option>
  ...
  <option value="LANGUE ET LITERATURE ARABE">LANGUE ET LITERATURE ARABE</option>
  
  <option value="FRANCAIS">FRANCAIS</option>
  
  <option value="ANGALIS">ANGLAIS</option>

  <option value="ART DRAMATIQUE">ART DRAMATIQUE</option>

  <option value="ART CINEMATO-GRAPHIQUE">ART CINEMATO-GRAPHIQUE</option>
  ...
  <option value="PHYSIQUES APLIQUES">PHYSIQUES APLIQUES</option>
...
<div class="input-group"> 
  ...
  <td>numero de la carte d'etudiant<br></td>

  <td><input type="text" name="numetu" id="pincode" size="30"> <br></td>
...
<div class="input-group"> 
  ...
  <td>numero de la carte d'identite<br></td>

  <td><input type="text" name="numid" id="" size="30"> <br></td>
</tr>
</div> 
...
<tr>
  ...
  <td>numero de telephone<br></td>

  <td><input type="text" name="numtel" id="" size="30"> <br></td>
  ...
  <td>scanne du certificat de scholarite<br></td>

  <td><input type="file" name="scansert" id="" > <br></td>
...
<div class="input-group"> 
  ...
  <td>scanne certficat de residence(residence actuelle)<br></td>

  <td><input type="file" name="scanres" id="" > <br></td>
...
<div class="input-group"> 
 <tr>
  ...
  <td>scanne certficat de naissance<br></td>

  <td><input type="file" name="scannais" id="" > <br></td>
...
<div class="input-group"> 
 <tr>
  ...
  <td>scanne certficat du bacaloreat<br></td>

  <td><input type="file" name="scanbac" id="" > <br></td>
...
<div class="input-group"> 
<tr>
 <td>scanne de la carte d'identite ou (passport , persmis de conduite)<br></td>

  <td><input type="file" name="scanid" id="" > <br></td>
  ...
  <td><button type="submit" class="btn" name="register_btn1" onclick="myFunction()">valider formulaire</button><br></td>
  </tr>
