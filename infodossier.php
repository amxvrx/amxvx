...
<div id="pageintro" class="hoc clear"> 
    <!-- ################################################################################################ -->
	<article>
      <h3 class="heading">INFORMATIONS ADMINISTRATIVES</h3>
	  <p>ensemble des papier et demarches necessaires</p>
    </article>
    <!-- ################################################################################################ -->
  </div>
  <!-- ######################
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      <!-- ################################################################################################ -->
		<br>
      <h6 class="heading">-dosser pour demande logement-</h6>

       <p>scan certificat scholarite universitaire</p>
	   <p>scan certificat du bacaloriat</p>
	   <p>scan certificat de naissance</p>
	   <p>scan certificat de residence</p>
	   <p>scan papier d'identite (carte nationale)</p>
      
	  <br>
	  <h6 class="heading">-dosser pour renouvellement-</h6>
       <p>scan certificat scholarite de la nouvelle annee universitaire</p>
	  <br>
